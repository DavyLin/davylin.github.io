    ...
    (unless (org-element-property :footnote-section-p headline)
      (let* ((email (org-export-data (plist-get info :email) info))
	     ...
	     (title (org-rss-plain-text
			 ...
			 (let ((hl-link (car (org-element-property :title headline))))
			   (buffer-substring-no-properties (org-element-property :contents-begin hl-link)
							   (org-element-property :contents-end hl-link)))) info))
	     (publink
